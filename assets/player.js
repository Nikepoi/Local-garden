...
const css =   /* Download list styles injected by assets/player.js */   .download-list { display:flex; flex-direction:column; gap:10px; margin-top:12px; }   .download-link.item {   display:flex;   align-items:center;   justify-content:space-between;   background:#000;   color:#fff;   padding:14px;   border-radius:12px;   text-decoration:none;   font-weight:700;   gap:8px;   box-shadow: 0 6px 14px rgba(0,0,0,0.12);   }   .download-link.item .dl-left { flex:0 0 auto; }   .download-link.item .dl-source { color:#fff; font-weight:800; text-transform:none; }   .download-link.item .dl-center { flex:1 1 auto; padding:0 12px; color:#fff; font-weight:700; white-space:nowrap; overflow:hidden; text-overflow:ellipsis; }   .download-link.item .dl-right { flex:0 0 auto; color:#fff; opacity:0.95; font-weight:700; }   .download-hint { color:var(--muted,#6b7280); font-size:13px; padding:8px 4px; }   .playlist-controls { margin-top:8px; gap:8px; display:flex; align-items:center; }  ;
try {
